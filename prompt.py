...
# Prompt Arguments DataClass (used in Prompt nn.Module)
...
class Prompt(nn.Module):
    def __init__(self, args: PromptArgs):
        ...
        self.prompt_pool = args.prompt_pool
        self.embedding_key = args.embedding_key
        self.prompt_init = args.prompt_init
        self.prompt_key = args.prompt_key
        self.pool_size = args.pool_size
        self.top_k = args.top_k
        self.batchwise_prompt = args.batchwise_prompt

        if self.prompt_pool:
            prompt_pool_shape = (args.pool_size, args.length, args.embed_dim)
        ...
        if args.prompt_key:
            key_shape = (args.pool_size, args.embed_dim)
